...
Write-Host "`nV1.0.0.7 adıyla Release oluşturuluyor ve LockKeyIndicator.exe yükleniyor..." -ForegroundColor Cyan
& $gh release create v1.0.0.7 ".\LockKeyIndicator.exe" --title "V1.0.0.7" --notes "Yayınlanabilir güncel sürüm"
