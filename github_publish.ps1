...
Write-Host "`nV1.0.0.6 adıyla Release oluşturuluyor ve LockKeyIndicator.exe yükleniyor..." -ForegroundColor Cyan
& $gh release create v1.0.0.6 ".\LockKeyIndicator.exe" --title "V1.0.0.6" --notes "Yayınlanabilir güncel sürüm"
