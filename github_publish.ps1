...
Write-Host "`nV1.0.0.5 adıyla Release oluşturuluyor ve LockKeyIndicator.exe yükleniyor..." -ForegroundColor Cyan
& $gh release create v1.0.0.5 ".\LockKeyIndicator.exe" --title "V1.0.0.5" --notes "Yayınlanabilir güncel sürüm"
